...
public class PromoMainAdapter extends PagerAdapter {

    private Context context;
    private ViewPager pager;
    private ArrayList<EntityPromo> promoArrayList;
    ...
    public PromoMainAdapter(Context context, ArrayList<EntityPromo> promoArrayList) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        if (promoArrayList != null) {
            ...
            EntityPromo entity = promoArrayList.get(position);

            View itemView = mLayoutInflater.inflate(R.layout.promo_main_item, container,
                    false);
            ...
            if (entity.getDescription() != null)
                textViewContent.setText(entity.getDescription());
            ...
            imageViewLike.setOnClickListener(view -> {
                ...
                ApiFactory.getInstance().getApiService().likePromo(String.valueOf(Session.getInstance().getUserId()),
            ...
            itemView.findViewById(R.id.imageViewShare).setOnClickListener(view -> {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT, Constants.SERVER_ADDRESS + "/promo_/" + entity.getId());
            ...
            if (position == promoArrayList.size() - 1)
